      ...
      <div className="md:flex md:flex-none justify-center bg-white shadow-lg shadow-gray-400 rounded-xl">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="md:text-2xl font-bold text-green-600">
                  Edu<span className="text-black">Manage</span>
                </h1>
                <p className="text-xs md:text-2xs">School Management System</p>
              </div>
            </div>
            <div>
              <h1 className="font-['Idiqlat'] font-extralight text-3xl md:text-5xl font-bold">
                Welcome Back!
              </h1>
        ...
        <div className="md:w-[500px] p-3">
          <div className="flex justify-between">
            ...
            <div
              className="flex gap-2 items-center cursor-pointer text-gray-600"
              onClick={() => navigate("/")}
            >
              <FaArrowLeft />
              <p>Back to Home</p>
          ...
          <div className="mt-3 mb-3">
            ...
            <p className="text-gray-600">
              Fill in the details below to get started with EduManage.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            {["Student/Guardian", "Admin"].map((r, index) => (
              <>
                <div
                  key={index}
                  className="px-5 py-2 border border-gray-300 rounded-[7px]  cursor-pointer w-full text-center"
                  onClick={() => setRole(r)}
                  style={
                    role == r
                      ? {
          ...
          {error && (
            <>
              <p className="text-red-500 my-3 flex justify-center items-center gap-3">
                *{error}
              </p>
            </>
          )}
          ...
          <button
            className="w-full py-3 rounded-lg text-white font-semibold bg-gradient-to-r from-green-600 via-teal-500 to-cyan-600 flex justify-center items-center gap-3 cursor-pointer mt-4"
          ...
          <button
            className="flex justify-center items-center w-full border border-gray-200 rounded-xl py-3 cursor-pointer gap-3"
            onClick={googleAuth}
          >
