      ...
      <div className='flex justify-center bg-white shadow-lg shadow-gray-400 rounded-xl'>
        ...
        <div className='relative w-[70%]'>
          ...
          <div className='px-10 absolute top-3'>
            ...
            <div>
              <h1 className="font-['Idiqlat'] font-extralight text-5xl font-bold">Forgot Password?</h1>
              <p className="mt-2">No worries! Enter your email address and</p>
              <p className="mb-4">we'll send you a reset link.</p>
            </div>
          </div>
        ...
        <div className='w-[50%] p-10'>
          ...
          {step == 1 &&
            <div className='flex items-center gap-4 bg-green-50 mt-6 px-5 py-3 rounded-xl'>
              ...
              <div>
                <h4 className='font-semibold text-xl'>Check your email</h4>
                <p className='text-gray-600'>We'll send a password reset link to you inbox </p>
                <p className='text-gray-600'>within a few minutes</p>
              </div>
            </div>}
          {step == 2 &&
            <div className='flex items-center gap-4 bg-green-50 mt-6 px-5 py-3 rounded-xl'>
              ...
              <div>
                <h4 className='font-semibold text-xl'>Check your OTP</h4>
                <p className='text-gray-600'>We'll send a password reset link to you inbox </p>
                <p className='text-gray-600'>with in a few minutes</p>
              </div>
            </div>}
          {step == 3 &&
            <div className='flex items-center gap-4 bg-green-50 mt-6 px-5 py-3 rounded-xl'>
              ...
              <div>
                <h4 className='font-semibold text-xl'>Check your Password</h4>
                <p className='text-gray-600'>We'll send a password reset link to you inbox </p>
                <p className='text-gray-600'>with in a few minutes</p>
              </div>
            </div>}
