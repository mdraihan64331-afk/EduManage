...
function EditTeacher() {
    ...
    const fetchTeacher = async () => {
      try {
        const result = await axios.get(
          `${serverURL}/api/teacher/teacher/${id}`,
          {
  ...
  const handleEditTeacher = async (e) => {
    ...
    try {
      ...
      const result = await axios.put(
        `${serverURL}/api/teacher/edit-teacher/${id}`,
        formData,
        { withCredentials: true },
      );
      ...
      const teachers = await axios.get(`${serverURL}/api/teacher/all-teacher`, {
        withCredentials: true,
      });
  ...
  const handleReset = async () => {
    try {
      const result = await axios.get(`${serverURL}/api/teacher/teacher/${id}`, {
        withCredentials: true,
      });
        ...
        <div className="p-2">
          ...
          <div className="p-4 bg-white rounded-[8px] mt-3 shadow flex justify-between">
            ...
            <div className="flex justify-center items-center mt-5 gap-4">
              {/* reset button */}
              <button
                className="relative overflow-hidden flex items-center justify-center gap-2 px-3 py-2.5 border border-blue-600 text-blue-600 rounded-lg cursor-pointer group"
                onClick={handleReset}
              >
                <span className="relative z-10 flex items-center gap-2 group-hover:text-white transition-colors duration-300">
                  <RiResetLeftFill /> Reset changes
                </span>
              ...
              {/* add button */}
              <button
                className="relative overflow-hidden flex items-center justify-center gap-2 px-3 py-2.5 border border-green-600 text-green-600 rounded-lg cursor-pointer group "
